				...
				<?php
					...
					<div class="vrc-promotion-car-block">
						...
						<div class="vrc-promotion-car-book-block">
							<a class="btn vrc-promotion-car-book-link vrc-pref-color-btn" href="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=cardetails&carid='.$car['id'].'&pickup='.$promo['promo_from_ts'].'&promo=1'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VRCPROMOCARBOOKNOW'); ?></a>
						</div>
					</div>
						<?php
					}
