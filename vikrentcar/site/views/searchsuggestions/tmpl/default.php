...
<div class="vrc-searchsuggestions-wrap">
	<div class="vrc-searchsuggestions-inner">
		<h4><?php echo JText::_('VRC_CLOSEST_SEARCHSOLUTIONS'); ?></h4>
		...
		foreach ($this->suggestions as $sug_dates) {
			...
			?>
				<div class="vrc-searchsuggestions-solution-booknow">
					<a class="btn vrc-pref-color-btn" href="<?php echo JRoute::_('index.php?' . http_build_query($use_query_vals)); ?>"><?php echo JText::_('VRBOOKNOW'); ?></a>
				</div>
			</div>
			<?php
			// increase counter
