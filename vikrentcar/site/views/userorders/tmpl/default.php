	...
	<div class="vrcsearchconfnumb">
		<form action="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=userorders'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" method="post">
			...
			<div class="vrcconfnumbsubm">
				<input type="submit" name="searchconfnum" class="btn vrc-pref-color-btn" value="<?php echo JText::_('VRCCONFNUMBERSEARCHBTN'); ?>"/>
			</div>
		</form>
	</div>
	<?php
		...
		<div class="vrc-orders-list-table">
			<div class="vrc-orders-list-table-head">
				<div class="vrc-orders-list-table-row vrc-orders-list-table-head-row">
					...
					<div class="vrc-orders-list-table-cell"><span><?php echo JText::_('VRCUSERRESDATE'); ?></span></div>
					<div class="vrc-orders-list-table-cell"><span><?php echo JText::_('VRPICKUP'); ?></span></div>
					<div class="vrc-orders-list-table-cell"><span><?php echo JText::_('VRRETURN'); ?></span></div>
				</div>
			</div>
			...
			foreach ($rows as $ord) {
				...
				<div class="vrc-orders-list-table-row vrc-orders-list-table-body-row vrc-orders-list-table-body-row-<?php echo $ord['status']; ?>">
					...
					<div class="vrc-orders-list-table-cell">
						<span class="vrc-orders-list-table-cell-lbl"><?php echo JText::_('VRCUSERRESDATE'); ?></span>
						<span><a href="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=order&sid='.$ord['sid'].'&ts='.$ord['ts'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo date($df . ' ' . $nowtf, $ord['ts']); ?></a></span>
					</div>
					<div class="vrc-orders-list-table-cell">
						<span class="vrc-orders-list-table-cell-lbl"><?php echo JText::_('VRPICKUP'); ?></span>
						<span><?php echo date($df . ' ' . $nowtf, $ord['ritiro']); ?></span>
					</div>
					<div class="vrc-orders-list-table-cell">
						<span class="vrc-orders-list-table-cell-lbl"><?php echo JText::_('VRRETURN'); ?></span>
