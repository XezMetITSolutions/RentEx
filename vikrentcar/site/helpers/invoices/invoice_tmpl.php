...
<div style="color: #444;">
	<table width="100%"  border="0" cellspacing="5" cellpadding="5">
		<tr>
			<td width="200">{company_logo}<br/>{company_info}</td>
			<td align="right" valign="bottom">
				<table width="250" border="0" cellpadding="1" cellspacing="1">
					<tr>
						<td align="right" bgcolor="#FFFFFF"><strong><?php echo JText::_('VRCINVNUM'); ?> {invoice_number}{invoice_suffix}</strong></td>
					</tr>
					<tr>
						<td align="right" bgcolor="#FFFFFF"><strong><?php echo JText::_('VRCINVDATE'); ?> {invoice_date}</strong></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table width="100%"  border="0" cellspacing="1" cellpadding="2">
		<tr bgcolor="#E1E1E1">
			<td width="40%"><strong><?php echo JText::_('VRCINVCOLDESCR'); ?></strong></td>
			<td width="20%"><strong><?php echo JText::_('VRCINVCOLNETPRICE'); ?></strong></td>
			<td width="20%"><strong><?php echo JText::_('VRCINVCOLTAX'); ?></strong></td>
			<td width="20%"><strong><?php echo JText::_('VRCINVCOLPRICE'); ?></strong></td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		<tr bgcolor="#E1E1E1">
			<td colspan="2" rowspan="3" valign="top"><strong><?php echo JText::_('VRCINVCOLCUSTINFO'); ?></strong><br>{customer_info}</td>
			<td width="244" align="left"><strong><?php echo JText::_('VRCINVCOLTOTAL'); ?></strong> {invoice_totalnet}</td>
		</tr>
		<tr bgcolor="#E1E1E1">
			<td align="left"><strong><?php echo JText::_('VRCINVCOLTAX'); ?></strong> {invoice_totaltax}</td>
		</tr>
		<tr bgcolor="#E1E1E1">
			<td align="left"><strong><?php echo JText::_('VRCINVCOLGRANDTOTAL'); ?></strong> {invoice_grandtotal}</td>
		</tr>
	</table>
	<br/>
</div>
