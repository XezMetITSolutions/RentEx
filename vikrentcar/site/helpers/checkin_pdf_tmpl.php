...
<h3><?php echo JText::_('VRCPDFCUSTOMERCHECKINTITLE'); ?></h3>
...
?>
{carfeature VRCDEFAULTDISTFEATUREONE}
{carfeature VRCDEFAULTDISTFEATURETWO}
{carfeature VRCDEFAULTDISTFEATURETHREE}
{carfeature Fuel In}
...
<p><?php echo JText::_('VRCPDFCUSTOMERCHECKINPARAGRAPH'); ?></p>
...
<table align="center" width="100%" style="width: 100%; text-align: center;">
	<tr>
		<td align="center" width="40%" style="width: 40%; text-align: center;"><strong><?php echo JText::_('VRCPDFCUSTOMERCHECKINCUSTSIGNATURE'); ?></strong></td>
		<td align="center" width="20%" style="width: 20%; text-align: center;"> &nbsp;</td>
		<td align="center" width="40%" style="width: 40%; text-align: center;"><strong><?php echo JText::_('VRCPDFCUSTOMERCHECKINADMINSIGNATURE'); ?></strong></td>
	</tr>
	<tr>
