	...
	<form name="adminForm" id="adminForm" action="index.php" method="post">
		...
		<div class="vrc-bookingdet-tab-cont" id="vrc-tab-details" style="display: block;">
			<div class="vrc-bookingdet-innercontainer">
				...
				<?php
				$contracted = file_exists(VRC_SITE_PATH . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'pdfs' . DIRECTORY_SEPARATOR . md5($row['id'] . '_' . $row['sid']) . '.pdf');
				$invoiced = file_exists(VRC_SITE_PATH . DIRECTORY_SEPARATOR . 'helpers' . DIRECTORY_SEPARATOR . 'invoices' . DIRECTORY_SEPARATOR . 'generated' . DIRECTORY_SEPARATOR . $row['id'] . '_' . $row['sid'] . '.pdf');
				...
				if ($contracted || $invoiced || $cancheckin || $is_ical_order) {
					...
					if ($cancheckin) {
						...
						<?php
						if (file_exists(VRC_SITE_PATH . DIRECTORY_SEPARATOR . "resources" . DIRECTORY_SEPARATOR . "pdfs" . DIRECTORY_SEPARATOR . md5($row['id'] . '_' . $row['sid']) . '_checkin.pdf')) {
						?>
						<div>
							<a href="<?php echo VRC_SITE_URI; ?>resources/pdfs/<?php echo md5($row['id'] . '_' . $row['sid']); ?>_checkin.pdf?<?php echo rand(); ?>=1" target="_blank" class="vrcpdfcheckin"><i class="fas fa-download"></i> <?php echo JText::_('VRCPDFCHECKIN'); ?></a>
						</div>
						<?php
						}
					}
					if ($contracted) {
						?>
						<div>
							<span class="label label-success"><span class="badge"><a href="<?php echo VRC_SITE_URI; ?>resources/pdfs/<?php echo md5($row['id'] . '_' . $row['sid']); ?>.pdf?<?php echo rand(); ?>=1" target="_blank"><i class="vrcicn-file-text2"></i><?php echo JText::_('VRCDOWNLOADPDF'); ?></a></span></span>
						</div>
						<?php
					}
					if ($invoiced) {
						?>
						<div>
							<span class="label label-success"><span class="badge"><a href="<?php echo VRC_SITE_URI; ?>helpers/invoices/generated/<?php echo $row['id'].'_'.$row['sid']; ?>.pdf?<?php echo rand(); ?>=1" target="_blank"><i class="vrcicn-file-text2"></i><?php echo JText::_('VRCDOWNLOADPDFINVOICE'); ?></a></span></span>
						</div>
						<?php
					}
					?>
