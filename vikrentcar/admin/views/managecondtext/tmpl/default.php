					...
					<div class="vrc-params-container">
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting">
								<input type="text" id="condtextname" name="condtextname" value="<?php echo count($this->condtext) ? JHtml::_('esc_attr', $this->condtext['name']) : ''; ?>" size="30" onkeyup="vrcComposeToken(this.value);" autocomplete="off" required />
							</div>
						</div>
					</div>
					<div class="vrc-params-container">
