...
class VikRentCarOfflineCreditCardPayment extends JPayment
{
	...
	protected function beginTransaction()
	{
		...
		$form .= "<div class=\"offline-cc-container\">\n";
			$form .= '<div class="offline-cc-row-group offline-cc-row-group-cardpan">';
			if (count($cardtypes)) {
				$form .= "<div class=\"offline-cc-row offline-cc-row-cardtype\"><div class=\"offline-cc-lbl\">".JText::_('VRCCCREDITCARDTYPE')." <sup>*</sup></div><div class=\"offline-cc-value\"><select name=\"credit_card_type\">\n";
				foreach ($cardtypes as $cardtype) {
					$form .= '<option value="'.$cardtype.'">'.$cardtype.'</option>'."\n";
				}
				$form .= "</select></div></div>\n";
			}
				$form .= "<div class=\"offline-cc-row offline-cc-row-cardpan\"><div class=\"offline-cc-lbl\">".JText::_('VRCCCREDITCARDNUMBER')." <sup>*</sup></div><div class=\"offline-cc-value\"><input type=\"text\" id=\"credit_card_number\" name=\"credit_card_number\" autocomplete=\"off\" size=\"20\" value=\"\" required/></div></div>\n";
			$form .= '</div>';
			$form .= '<div class="offline-cc-row-group offline-cc-row-group-validity">';
				$form .= '<div class="offline-cc-row offline-cc-row-validity"><div class="offline-cc-lbl">'.JText::_('VRCCVALIDTHROUGH').' <sup>*</sup></div><div class="offline-cc-value"><select name="expire_month">
				...
				if ($this->getParam('askcvv')) {
					$form .= "<div class=\"offline-cc-row offline-cc-row-cvv\"><div class=\"offline-cc-lbl\">".JText::_('VRCCCVV')." <sup>*</sup></div><div class=\"offline-cc-value\"><input type=\"text\" id=\"credit_card_cvv\" name=\"credit_card_cvv\" autocomplete=\"off\" size=\"5\" value=\"\" required/></div></div>\n";
				}
			$form .= '</div>';
			$form .= '<div class="offline-cc-row-group offline-cc-row-group-cardholder">';
				$form .= "<div class=\"offline-cc-row offline-cc-row-fname\"><div class=\"offline-cc-lbl\">".JText::_('VRCCFIRSTNAME')." <sup>*</sup></div><div class=\"offline-cc-value\"><input type=\"text\" id=\"business_first_name\" name=\"business_first_name\" autocomplete=\"off\" size=\"20\" value=\"\" required/></div></div>\n";
				$form .= "<div class=\"offline-cc-row offline-cc-row-lname\"><div class=\"offline-cc-lbl\">".JText::_('VRCCLASTNAME')." <sup>*</sup></div><div class=\"offline-cc-value\"><input type=\"text\" id=\"business_last_name\" name=\"business_last_name\" autocomplete=\"off\" size=\"20\" value=\"\" required/></div></div>\n";
			$form .= '</div>';

			$form .= "<div class=\"offline-cc-row offline-cc-row-submit\"><div class=\"offline-cc-value\" colspan=\"2\"><input type=\"submit\" id=\"offlineccsubmit\" name=\"offlineccsubmit\" class=\"button\" value=\"".JText::_('VROFFLINECCSEND')."\" onclick=\"javascript: event.preventDefault(); this.disabled = true; this.value = '".addslashes(JText::_('VROFFLINECCSENT'))."'; document.offlineccpaymform.submit(); return true;\"/></div></div>\n";
		$form .= "</div>\n";
		$form .= "<input type=\"hidden\" name=\"total\" value=\"".number_format((float)$this->get('total_to_pay'), 2)."\"/>\n";
