        ...
        <div className="min-h-screen bg-[#FDFDFD] dark:bg-[#0A0A0A] text-foreground selection:bg-red-500/30">
            ...
            <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">Unsere Dienstleistungen</h1>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, index) => (
                        <div key={index} className="bg-white dark:bg-zinc-900/50 p-8 rounded-3xl border border-gray-200 dark:border-white/10 hover:border-red-500/30 transition-all group shadow-sm dark:shadow-none">
