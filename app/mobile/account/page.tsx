      ...
      <div className="px-5 mt-8">
        {!customer ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="w-20 h-20 rounded-full bg-white dark:bg-[#1C1C1C] border border-gray-200 dark:border-white/5 flex items-center justify-center mb-6 transition-colors">
              <User className="w-10 h-10 text-gray-400 dark:text-[#A3A3A3]" />
            </div>
            <h2 className="text-[20px] font-bold text-gray-900 dark:text-white mb-2">Willkommen bei RentEx</h2>
            <p className="text-[14px] text-gray-500 dark:text-[#A3A3A3] mb-8 px-4">
              Bitte melden Sie sich an, um Ihr Profil und Ihre Buchungen zu verwalten.
            </p>
            <Link href="/login" className="w-full bg-[#E53935] py-4 rounded-xl font-bold text-white text-center hover:bg-red-700 transition-colors">
          ...
          <>
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h2 className="text-[18px] font-bold text-gray-900 dark:text-white">{customer.firstName} {customer.lastName}</h2>
                <p className="text-[12px] text-gray-500 dark:text-[#A3A3A3]">{customer.email}</p>
              </div>
            </div>

            <div className="space-y-3">
              <Link href="/dashboard/profile?mobile=true&back=/mobile/account" className="w-full bg-white dark:bg-[#1C1C1C] border border-gray-200 dark:border-white/5 p-4 rounded-2xl flex items-center justify-between hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
              ...
              <Link href="/dashboard/rentals?mobile=true&back=/mobile/account" className="w-full bg-white dark:bg-[#1C1C1C] border border-gray-200 dark:border-white/5 p-4 rounded-2xl flex items-center justify-between hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
                <div className="flex items-center gap-3">
              ...
              <Link href="/dashboard/settings?mobile=true&back=/mobile/account" className="w-full bg-white dark:bg-[#1C1C1C] border border-gray-200 dark:border-white/5 p-4 rounded-2xl flex items-center justify-between hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
                <div className="flex items-center gap-3">
