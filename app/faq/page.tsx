            ...
            <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-zinc-900/50 rounded-2xl border border-white/10 p-6">
                        <h3 className="text-lg font-bold text-white mb-3">Welche Dokumente benötige ich für die Anmietung?</h3>
                    ...
                    {/* FAQ Item 2 */}
                    <div className="bg-zinc-900/50 rounded-2xl border border-white/10 p-6">
                        <h3 className="text-lg font-bold text-white mb-3">Wie hoch ist die Kaution?</h3>
                        <p className="text-gray-400 leading-relaxed">
                    ...
                    {/* FAQ Item 3 */}
                    <div className="bg-zinc-900/50 rounded-2xl border border-white/10 p-6">
                        <h3 className="text-lg font-bold text-white mb-3">Sind die Kilometer begrenzt?</h3>
                        <p className="text-gray-400 leading-relaxed">
                    ...
                    {/* FAQ Item 4 */}
                    <div className="bg-zinc-900/50 rounded-2xl border border-white/10 p-6">
                        <h3 className="text-lg font-bold text-white mb-3">Kann ich das Fahrzeug an einem anderen Ort zurückgeben?</h3>
                        <p className="text-gray-400 leading-relaxed">
                    ...
                    {/* FAQ Item 5 */}
                    <div className="bg-zinc-900/50 rounded-2xl border border-white/10 p-6">
                        <h3 className="text-lg font-bold text-white mb-3">Was passiert im Falle einer Panne oder eines Unfalls?</h3>
                        <p className="text-gray-400 leading-relaxed">
