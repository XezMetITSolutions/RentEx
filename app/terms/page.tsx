        ...
        <div className="min-h-screen bg-black text-white selection:bg-red-500/30">
            ...
            <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                <div className="prose prose-invert prose-lg max-w-none text-gray-300 space-y-12">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">1. Allgemeines</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">2. Weitergabe / Ausdehnung auf den Fahrzeuglenker</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">3. Fahrzeugübernahme</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">4. Auslandsfahrten</h2>
                        <p className="mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">8. Zahlungsbedingungen</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">9. Mehrkilometer</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">10. Datenschutz</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">11. Konsumentenschutz</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">12. Rechtswahl, Gerichtsstand</h2>
                        <p>
