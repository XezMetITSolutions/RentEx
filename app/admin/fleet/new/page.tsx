...
import { ArrowLeft, Car, Save, Tag, FileText, ShieldCheck, Wrench, DollarSign, Settings as SettingsIcon, CheckCircle } from 'lucide-react';
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select name="currentLocation" className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-lg focus:ring-2 focus:ring-red-500 dark:text-white">
                                        <option>Hauptfiliale München</option>
                                        <option>Filiale Frankfurt</option>
                                        <option>Filiale Berlin</option>
                                        <option>Filiale Hamburg</option>
                                        <option>Filiale Köln</option>
                                        <option>Filiale Stuttgart</option>
                                    </select>
                                </div>
                            </div>
                        </div>
