    ...
    return (
        <div className="min-h-screen bg-background text-foreground selection:bg-red-500/30">
            ...
            <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-10">DSGVO-Informationstext</h1>

                <div className="prose dark:prose-invert prose-lg max-w-none text-gray-600 dark:text-gray-400 space-y-8">
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Informationspflicht laut DSGVO</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">1. Rechtsgrundlagen der Verarbeitung</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">2. Speicherdauer</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">3. Beschwerderecht</h2>
                        <p>
                    ...
                    <div className="bg-gray-50 dark:bg-zinc-900/50 p-6 rounded-2xl border border-gray-200 dark:border-white/10 mt-8">
                        <p className="text-sm">
